...
//*** <<< end of configuration section >>>    ***
	...
	NVIC_SetPriority(TIMER0_IRQn,3);   // Timer for the animations, lower priority
	return (1);
  }
  else if ( timer_num == 1 )
  {
	...
	NVIC_EnableIRQ(TIMER1_IRQn);
		NVIC_SetPriority(TIMER1_IRQn,2);  // Timer for the age 
	return (1);
  }
	else if ( timer_num == 2 )
  {
	...
	NVIC_EnableIRQ(TIMER2_IRQn);
		NVIC_SetPriority(TIMER2_IRQn,0);  // Timer for the note duration 
	return (1);
  }
	else if ( timer_num == 3 )
  {
	...
	NVIC_EnableIRQ(TIMER3_IRQn);
		NVIC_SetPriority(TIMER3_IRQn,1);  // Timer for the sound
	return (1);
  }
